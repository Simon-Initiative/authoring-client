...
export function getAllDataSets(course: CourseIdVers): Promise<GetAllDataSetsResponse> {
...
export function createDataSet(course: CourseIdVers): Promise<CreateDatasetResponse> {
