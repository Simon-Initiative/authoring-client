...
function goToObjectivesPage(
  label: string, courseId: CourseIdVers, orgId: ResourceId): Messages.MessageAction {
  return {
    label,
    enabled: true,
    execute: (message: Messages.Message, dispatch) => {
...
export function buildMissingObjectivesMessage(courseId: CourseIdVers, orgId: ResourceId) {
...
export function buildMissingSkillsMessage(courseId: CourseIdVers, orgId: ResourceId) {
