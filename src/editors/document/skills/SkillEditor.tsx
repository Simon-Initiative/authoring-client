          ...
          <div id={'skill-' + index} key={'skill-' + index} style={styles.skillRowUnselected}>
            <div style={styles.titleBarFolded}>
              ...
              <div style={styles.toolContainer}>
                <a style={styles.orgrowTitleFolded} href="#" onClick={(e) => this.deleteNode(item, item.title)}><i
                  className="fa fa-window-close">&nbsp;</i></a>
                <a style={styles.orgrowTitleFolded} href="#" onClick={(e) => this.fold(item)}><i
        ...
        return (
          <div id={'skill-' + index} key={'skill-' + index} style={styles.skillRowSelected}>
            <div style={styles.titleBarUnfolded}>
              ...
              <div style={styles.toolContainer}>
                <a style={styles.orgrowTitleUnfolded} href="#" onClick={(e) => this.deleteNode(item, item.title)}><i
                  className="fa fa-window-close">&nbsp;</i></a>
                <a style={styles.orgrowTitleUnfolded} href="#" onClick={(e) => this.fold(item)}><i
