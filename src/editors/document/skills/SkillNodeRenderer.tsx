                            ...
                            <div id="outter" style={dStyle as any}>
                               <div id="inner" style={tStyle}>
                                 <TitleContentEditor 
                                   ...
                                   editMode={true}
                                   model={titleObj}
                                   context={{resourcePath: null, courseModel: null, userId: null, documentId: null, undoRedoGuid: null, courseId: null, baseUrl: null}}
                                   onEdit={(content) => this.editNodeTitle(node,content)} 
                                    />
                               </div>
                               <a style={bStyle} onClick={(e) => this.deleteNodeFunction (node)}><i className="fa fa-window-close">&nbsp;</i></a>
                            </div>
                        </div>
                    )}
                </div>
